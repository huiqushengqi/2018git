...
window.FlexPaperViewerEmbedding = window.$f = function(id, args) {
    ...
    window[instance] = flashembed(id, {
        src						    : _jsDirectory+"/pages/assets/flash/FlexPaperViewer.swf",
        version					    : [10, 0],
...
(function() {
    ...
    var f = extend(window.flashembed, {
        ...
        getHTML: function(opts, conf) {
            ...
            var html = '<object style="position: relative; z-index: 1000; visibility: visible;" width="' + opts.width +
                '" height="' + opts.height +
                '" id="' + opts.id +
                '" name="' + opts.id + '"';
    ...
    function Flash(root, opts, conf) {
        ...
        } else { //use thymeleaf viewer or die
