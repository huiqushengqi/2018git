...
!function ($) {
    ...
    var DateRangePicker = function (element, options, cb) {
        ...
        var DRPTemplate = '<div class="daterangepicker dropdown-menu">' +
                '<div class="ranges">' +
                  '<div class="range_inputs" style="margin-left:5%">' +
                    ...
                    '</div>' +
                    '<button style="margin-left:10%" class="btn btn-small btn-success" disabled="disabled">' + this.locale.applyLabel + '</button>' +
                  '</div>' +
                '</div>' +
    ...
    DateRangePicker.prototype = {
        ...
        renderCalendar: function (calendar, selected, minDate, maxDate) {
            ...
            /**
             * 应卓修改 Start
             * 日期控件显示时 年在前，月在后 中文习惯与英文相反
             */
            // thymeleaf += '<th colspan="5">' + this.locale.monthNames[calendar[1][1].getMonth()] + calendar[1][1].toString(" yyyy") + '</th>';
            html += '<th colspan="5">' + calendar[1][1].toString("yyyy年") + this.locale.monthNames[calendar[1][1].getMonth()] + '</th>';
            /**
             * 应卓修改 End
             */
