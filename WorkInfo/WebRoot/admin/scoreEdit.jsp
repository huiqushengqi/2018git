...
$(document).ready(function(){
    ...
    function loadStudent(score_year,score_year_half,course_id){
    	if(score_year!='' && score_year_half!='0' && course_id!='0'){
    		...
    		$("#op2").show();
    		var postParams={'paramsUser.scource_year':score_year,'paramsUser.scource_year_half':score_year_half,'paramsUser.course_id':course_id};
   ...
   <tr>
     ...
     <table width="100%" align="center" cellpadding="1" cellspacing="1" class="editbody">
       <tr>
          ...
          <td width="65%">
            <s:textfield name="paramsScore.score_year" id="score_year" value="%{#attr.score==null?'2015':#attr.score.score_year}" onfocus="WdatePicker({skin:'whyGreen',dateFmt:'yyyy'})"/>
          </td> 
       </tr>
       <tr>
       ...
       <tr>
          ...
          <td>
          	<s:select list="#attr.courses" name="paramsScore.course_id" id="course_id" value="%{#attr.paramsScore.course_id}" 
          			listKey="course_id" listValue="course_name" headerKey="0" headerValue="选择课程"  
          			cssClass="selectstyle" cssStyle="width:155px">
          	</s:select>
          </td>
       </tr> 
       <tr>
          ...
          <td>
            <select id="user_id" name="paramsScore.user_id"  style="width:155px">
