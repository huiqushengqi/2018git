		...
		<!-- 				<TR>
						...
						<TR>
							...
							<TD colspan="3" valign="middle">
								<img id="loginInBtn"  style="border:0px;cursor:pointer;vertical-align:text-bottom;width: 200px;" src="images/login.png" />&nbsp;&nbsp;
								<a style="color:#ff5511;font-weight:bold;font-size:14px;" href="Admin_inputUserName.action" >忘记密码？</a>
							</TD>
						</TR>
					</TBODY>
					</TABLE>
