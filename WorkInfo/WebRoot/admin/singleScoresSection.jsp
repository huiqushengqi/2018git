...
$(document).ready(function(){
	...
	$("#search").bind("click",function(){
	    ...
	    var course_id = $("#paramsScore\\.course_id").val();
...
<body>
<div class="pageTitle">
	&nbsp;&nbsp;<img src="images/right1.gif" align="middle" /> &nbsp;<span id="MainTitle" style="color:white">成绩统计&gt;&gt;单科成绩分布</span>
</div>
...
<table width="95%" align="center" class="table_list" cellpadding="0" cellspacing="0">
   <tr>
   	<td id="Chart" width="100%" height="400px" align="center">
