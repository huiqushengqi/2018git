...
function serch()
{
   document.info.action="Admin_listTeachers.action";
...
function del()
{
    ...
    if(confirm('确认删除吗!?'))
    {
       document.info.action="Admin_delTeachers.action?paramsUser.ids="+ids;
       document.info.submit();
    }
...
<body>
<div class="pageTitle">
	&nbsp;&nbsp;<img src="images/right1.gif" align="middle" /> &nbsp;<span id="MainTitle" style="color:white">教师管理&gt;&gt;教师查询</span>
</div>
<form name="info" id="info" action="Admin_listTeachers.action" method="post">
  ...
  <tr>
    ...
    <td width="" align="right">
      ...
      <input type="text" id="paramsUser.user_name" name="paramsUser.user_name" value="${paramsUser.user_name}" class="inputstyle"/>&nbsp;
            姓名：
      <input type="text" id="paramsUser.real_name" name="paramsUser.real_name" value="${paramsUser.real_name}" class="inputstyle"/>&nbsp;&nbsp;
...
<table width="95%" align="center" class="table_list" cellpadding="0" cellspacing="0">
   ...
   <tr class="<s:if test='(#status.index + 1)%2==0'>list1</s:if><s:else>list0</s:else>" onmouseover="tr_mouseover(this)" onmouseout="tr_mouseout(this)"> 
     ...
     <td width="" align="center">
       <img src="images/edit.png"/>&nbsp;<s:a href="Admin_editTeacher.action?paramsUser.user_id=%{#user.user_id}">编辑</s:a>
     </td>
   </tr> 
   </s:iterator>
   </s:if>
   <s:else>
   <tr>
     <td height="60" colspan="10" align="center"><b>&lt;不存在教师信息&gt;</b></td>
   </tr>
   </s:else>
